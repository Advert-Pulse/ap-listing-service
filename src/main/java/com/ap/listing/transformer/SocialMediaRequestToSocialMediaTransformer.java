...
/*
  ...
  File: SocialMediaRequestToSocialMediaTransformer
 */
...
@Slf4j
public class SocialMediaRequestToSocialMediaTransformer {

    public SocialMedia transform(SocialMediaRequest socialMediaRequest) {
